describe('declaring variable etc wtih TypeScript', () => {
  describe('eventual typing', () => {

    it('an example of evental typing', () => {
      let age: number;
      age = 49;
      expect(age).toBe(49);
    ...
    describe('literals in typescript', () => {
      ...
      describe('tuples', () => {
        ...
        it('formatting a name with a tuple', () => {
          ...
          const [fn, len] = formatName('Hans', 'Solo');
          expect(fn).toBe('Solo, Hans');
          expect(len).toBe(10);
